<div class="affix sidebarMain" style = "background-color: white;">
	<ul class="nav nav-pills nav-stacked">
		...
		<li id = "user-nav">
			<a href="<?php echo base_url();?>admin/get_user"><span class="glyphicon glyphicon-user"></span> &nbsp;Search User</a>
		</li>
		<li id = "overview-nav">
