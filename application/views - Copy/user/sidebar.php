<?php 
	...
	if($this->session->userdata('sex') == 'F'){
		echo "<img src='/icslibsystem/dist/images/derpina.png' alt='' class='img-rounded img-responsive' />";
	}
	else{
		echo "<img src='/icslibsystem/dist/images/derp.png' alt='' class='img-rounded img-responsive' />";
	}
?>
